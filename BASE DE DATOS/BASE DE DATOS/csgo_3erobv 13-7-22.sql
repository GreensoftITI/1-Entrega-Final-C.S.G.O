...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-07-2022 a las 04:50:09
...
CREATE TABLE `asocia` (
  `Codigo_Vegetal_Primario` int(6) NOT NULL COMMENT 'Número con el cual se identifica el vegetal a principal',
  `Codigo_Vegetal_Asociado` int(6) NOT NULL COMMENT 'Número con el cual se identifica el vegetal que se le asocia al principal'
...
CREATE TABLE `calendario` (
  `Fecha_Inicio` datetime NOT NULL COMMENT 'Fecha en cual inicia la etapa de plantar el vegetal. ',
  `Fecha_Fin` datetime NOT NULL COMMENT 'Fecha en cual finaliza la etapa de plantar el vegetal. ',
  ...
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica el vegetal',
  `ID_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica la variedad del vegetal.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `cliente` (
  `N°_Cliente` int(6) NOT NULL COMMENT 'Numero por el cual se identifica al cliente.',
...
CREATE TABLE `cliente_empresa` (
  `N°_Cliente` int(6) NOT NULL COMMENT 'Número por el cual se identifica al cliente ',
  `Nombre` varchar(16) NOT NULL COMMENT 'Nombre de la empresa',
  `RUT` int(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `cliente_web` (
  ...
  `CI` int(8) NOT NULL COMMENT 'Cedula de identidad '
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `control` (
  `Fecha_Inicio_Vegetal` datetime NOT NULL COMMENT 'Fecha en la cual el vegetal paso a estar en un estado.',
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica al vegetal.',
  `ID_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica a la variedad del vegetal.',
  `Fecha_Final_Vegetal` datetime NOT NULL COMMENT 'Fecha en la cual el vegetal finalizo este estado. ',
  `Id_Estado_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica en que estado esta el vegetal.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `cultiva` (
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica al vegetal.	',
  `ID_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica la variedad del vegetal.	',
  `ID_Huerta` int(6) NOT NULL COMMENT 'Número por el cual se identifica la huerta.',
  `Fecha` datetime NOT NULL COMMENT 'Fecha en la que se cultivo el vegetal. ',
  `Unidad` varchar(16) NOT NULL COMMENT 'En que unidad se mide el vegetal.',
...
CREATE TABLE `esta` (
  ...
  `N°_Pedido` int(6) NOT NULL COMMENT 'Numero por el cual se identifica el pedido.',
  `Fecha_De_Entrega` datetime NOT NULL,
  `Id_Estado_Pedido` int(6) NOT NULL COMMENT 'Número por el cual se identifica en que estado esta el pedido.',
...
CREATE TABLE `estado_pedido` (
  `Id_Estado_Pedido` int(6) NOT NULL COMMENT 'Número por el cual se identifica el estado en el que esta el pedido.	',
  `Nombre_Estado_Pedido` varchar(16) NOT NULL COMMENT 'El nombre del estado que esta el pedido.',
  `N°_Pedido` int(6) NOT NULL COMMENT 'Número por el cual se identifica el pedido.',
  `Fecha_De_Entrega` datetime NOT NULL COMMENT 'Fecha de entrega del pedido.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `estado_vegetal` (
  `Id_Estado_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica en que estado esta el vegetal.	',
  `Estado_Del_Vegetal` varchar(16) NOT NULL COMMENT 'Nombre del estado en el que esta el vegetal.',
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica al vegetal.	',
  `Id_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica a la variedad del vegetal.	'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `huerta` (
  `ID_Huerta` int(6) NOT NULL COMMENT 'Número por el cual se identifica la huerta.',
  `Tamaño_Huerta` varchar(16) NOT NULL COMMENT 'El tamaño de la huerta'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `usuario` (
  ...
  `Rol` varchar(16) NOT NULL COMMENT 'Rol que cumple en la empresa.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `variedad` (
  `ID_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica la variedad del vegetal.',
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica el vegetal.',
  `Variedad_Nombre` varchar(16) NOT NULL COMMENT 'Nombre de la variedad del vegetal.'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `vende` (
  `Fecha_Venta` datetime NOT NULL COMMENT 'Fecha en la cual se hizo la venta. ',
  `Codigo_Vegetal` int(6) NOT NULL COMMENT 'Número por el cual se identifica el vegetal.',
  `ID_Variedad` int(6) NOT NULL COMMENT 'Número por el cual se identifica la variedad del vegetal.',
...
--
ALTER TABLE `realiza`
  ADD KEY `N°_Cliente` (`N°_Cliente`,`N°_Pedido`,`Fecha_De_Entrega`),
  ADD KEY `N°_Pedido` (`N°_Pedido`);
...
ALTER TABLE `realiza`
  ...
  ADD CONSTRAINT `realiza_ibfk_2` FOREIGN KEY (`N°_Pedido`) REFERENCES `pedido` (`N°_Pedido`) ON DELETE CASCADE;
